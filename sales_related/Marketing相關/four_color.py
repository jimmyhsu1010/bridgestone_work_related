...
place_list = ["臺北市區監理所", "士林監理站", "臺北區監理所", "宜蘭監理站", "花蓮監理站", "新竹區監理所", "新竹市監理站", 
              "桃園監理站", "中壢監理站", "苗栗監理站", "臺中區監理所", "豐原監理站", "彰化監理站", "南投監理站", 
              "雲林監理站", "嘉義市監理站", "嘉義區監理所", "麻豆監理站", "臺南監理站", "高雄市區監理所", "旗山監理站", "高雄區監理所",
              "屏東監理站", "臺東監理站"]
tour_bus_list = [
